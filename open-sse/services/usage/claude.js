...
export async function getClaudeUsage(accessToken, providerSpecificData = null, proxyOptions = null) {
  try {
    ...
    if (oauthResponse.ok) {
      ...
      return {
        plan:
          data.tier || data.plan || data.subscription_type ||
          data.bootstrap?.organization_rate_limit_tier ||
          providerSpecificData?.organizationRateLimitTier || "",
