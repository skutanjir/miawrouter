...
Integra MiawRouter con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de MiawRouter.
...
Establece la URL base a tu endpoint de MiawRouter:

**Para MiawRouter local:**
```
...
**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de MiawRouter
...
3. La key debe comenzar con `sk-miawrouter-`

### 5. Seleccionar modelo

1. En el dropdown **Model**, puedes:
   - Seleccionar de los modelos disponibles (si Cline los auto-detecta)
   - Ingresar manualmente el nombre del modelo desde tu configuración de MiawRouter
...
4. Cline usará MiawRouter para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando MiawRouter
...
3. Obtén explicaciones potenciadas por IA a través de MiawRouter

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará MiawRouter para entender el contexto y hacer cambios
...
2. Verifica que tu instancia de MiawRouter esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de MiawRouter para cualquier error
...
1. En la configuración de Cline, establece Base URL a: `https://miawrouter.web.id`
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de MiawRouter
...
## Integración con características de MiawRouter

### Enrutamiento de modelos

MiawRouter enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, MiawRouter automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de MiawRouter:
