...
Deploy MiawRouter on VPS or Docker for remote access and production use.
...
| `DATA_DIR` | `~/.miawrouter` | Database and data storage path |
...
Create `/etc/nginx/sites-available/miawrouter`:
