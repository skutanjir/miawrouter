...
describe("request normalization", () => {
  it("claudeToOpenAIRequest preserves text content arrays", () => {
    const body = {
      messages: [
        {
          role: "user",
  ...
  it("filterToOpenAIFormat preserves text content arrays", () => {
    const body = {
      messages: [
        {
          role: "user",
  ...
  it("translateRequest keeps /v1/messages Claude->OpenAI text payloads array structure", () => {
    const body = {
