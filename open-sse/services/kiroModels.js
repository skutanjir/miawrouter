 ...
 * into MiawRouter-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are MiawRouter fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic MiawRouter variant set for a single upstream Kiro model.
 *
 ...
 * into MiawRouter variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
