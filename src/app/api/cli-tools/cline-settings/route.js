...
const hasMiawRouterConfig = (globalState) => {
  ...
  return isOpenAi && (baseUrl.includes("localhost") || baseUrl.includes("127.0.0.1") || baseUrl.includes("miawrouter"));
};
...
export async function DELETE() {
  try {
    ...
    return NextResponse.json({ success: true, message: "MiawRouter settings removed from Cline" });
  } catch (error) {
