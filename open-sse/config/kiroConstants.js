 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what MiawRouter needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a MiawRouter
 ...
 * The suffix is a MiawRouter request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a MiawRouter synthetic agentic variant.
...
/**
 * Detect whether a model id is a MiawRouter synthetic thinking variant
...
/**
 * Resolve a MiawRouter model id to the real upstream Kiro model id, plus flags
