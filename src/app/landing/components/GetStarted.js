      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex gap-4">
                <div className="flex-none w-8 h-8 rounded-full bg-[#168BFF]/20 text-[#168BFF] flex items-center justify-center font-bold">1</div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="flex-none w-8 h-8 rounded-full bg-[#168BFF]/20 text-[#168BFF] flex items-center justify-center font-bold">2</div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="flex-none w-8 h-8 rounded-full bg-[#168BFF]/20 text-[#168BFF] flex items-center justify-center font-bold">3</div>
                <div>
          ...
          <div className="flex-1 w-full">
            <div className="rounded-xl overflow-hidden bg-[#122239] border border-[#294563] shadow-2xl">
              {/* Terminal header */}
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-auto">
                ...
                <div className="text-gray-400 mb-6">
                  <span className="text-[#168BFF]">&gt;</span> Starting MiawRouter...<br/>
                  <span className="text-[#168BFF]">&gt;</span> Server running on <span className="text-blue-400">http://localhost:21128</span><br/>
                  <span className="text-[#168BFF]">&gt;</span> Dashboard: <span className="text-blue-400">http://localhost:21128/dashboard</span><br/>
