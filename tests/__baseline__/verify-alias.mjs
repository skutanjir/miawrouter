...
const ALIAS_TOKENS = [
  ...
  "gw","grok-web","gcli","gb","grok-build","grok-cli","pw","perplexity-web","kimi-web","mimo","xiaomi-mimo",
  ...
  "dv","devin","devin-cli","morph","morphllm","muse","meta","meta-ai","meta-model-api",
  "zen","ocz","opencode-zen",
];
