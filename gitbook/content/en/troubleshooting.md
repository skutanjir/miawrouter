...
Common issues and solutions when using MiawRouter.
...
1. **Auto-refresh (default):**
   MiawRouter automatically refreshes tokens. Wait 30 seconds and retry.
...
1. **Check if MiawRouter is running:**
   ```bash
   # Check process
